...
const CategoryHome = () => {
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark text-text-main-light dark:text-text-main-dark transition-colors duration-300 antialiased font-sans">
      <main className="max-w-7xl mx-auto px-6 py-16 lg:px-8 lg:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8">
          {cards.map((card, index) => (
            <div
              key={index}
              className={`lg:col-span-${card.lgSpan} group relative overflow-hidden rounded-2xl shadow-soft hover:shadow-hover transition-all duration-500 cursor-pointer bg-card-light dark:bg-card-dark h-[300px]`}
            >
              <img
                alt={card.title}
        ...
        {/* Footer Quote */}
        <div className="mt-16 border-t border-primary/10 dark:border-white/5 pt-8 flex justify-center">
          <p className="text-center text-text-sub-light dark:text-text-sub-dark font-display italic text-lg opacity-60">
