    ...
    <div className="flex-1 rounded-3xl shadow-2xl p-8 md:p-10"
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit(handleRegistration)}>
        ...
        <div>
          ...
          />
          {errors.name && <p className="text-[#c55626] text-sm mt-1">Name is required.</p>}
        </div>
        ...
        <div>
          ...
          />
          {errors.photo && <p className="text-[#c55626] text-sm mt-1">Photo is required.</p>}
        </div>
        ...
        <div>
          ...
          />
          {errors.email && <p className="text-[#c55626] text-sm mt-1">Email is required.</p>}
        </div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="••••••••"
          />
          {errors.password?.type === "required" && <p className="text-[#c55626] text-sm mt-1">Password is required.</p>}
          {errors.password?.type === "minLength" && <p className="text-[#c55626] text-sm mt-1">Password must be 6 characters or longer</p>}
          {errors.password?.type === "pattern" && <p className="text-[#c55626] text-sm mt-1">At least 1 uppercase, 1 lowercase, 1 number, 1 special character</p>}
        </div>

        <div className="text-right">
          <a className="link link-hover" style={{ color: '#c55626' }}>Forgot password?</a>
        </div>
